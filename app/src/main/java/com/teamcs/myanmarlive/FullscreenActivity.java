...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            final String app_url = extras.getString("app_url");

            Log.e("JSON_OBJECT", extras.toString());
            ...
            // set those text in button listner and text view
